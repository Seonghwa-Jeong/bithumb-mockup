...
| 이메일                  | 닉네임       | 등급   | 전월 거래금액 | 보유원화     |
| ----------------------- | ------------ | ------ | ------------- | ------------ |
| trader01@bithumb.test   | 고래투자자   | 퍼플   | 15억원        | 50,000,000원 |
| newbie@bithumb.test     | 코린이       | 화이트 | 300만원       | 1,000,000원  |
| hodler@bithumb.test     | 존버마스터   | 그린   | 2.5억원       | 10,000,000원 |

회원가입도 지원하며, 신규 가입 시 실습용 원화 1,000,000원이 지급됩니다. (신규 = 화이트 등급)

### 등급 제도 (`src/lib/tiers.js`)

전월 1일~말일 거래금액 합산 기준으로 등급이 산정됩니다.

| 등급 | 전월 거래금액 | 거래포인트 | 메이커 리워드 |
| --- | --- | --- | --- |
| 화이트 | 1,000만원 미만 | 0.003% | — |
| 블루 | 1,000만원 이상 | 0.005% | — |
| 그린 | 1억원 이상 | 0.008% | — |
| 퍼플 | 10억원 이상 | 0.01% | 0.005% |
| 오렌지 | 100억원 이상 | 0.01% | 0.008% |
| 블랙 | 1,000억원 이상 | 0.01% | 0.01% |
